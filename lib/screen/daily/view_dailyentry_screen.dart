...
class ViewSingleEntryPage extends StatelessWidget {
  ...
  const ViewSingleEntryPage({super.key, required this.entry});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.white, // Pleasant, minimal background using UKM blue tint
      appBar: AppBar(
        title: const Text(
          "Logbook Entry",
          style: TextStyle(
            color: Colors.white ,
            fontWeight: FontWeight.w500, // Slightly lighter for minimalism
            letterSpacing: 0.5,
          ),
        ),
        centerTitle: true,
